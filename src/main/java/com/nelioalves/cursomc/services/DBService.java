...
public class DBService {
	...
	public void InstantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Franciole Bezerra", "franciole.curso@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123456"));

		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Franciole Bezerra ADMIN", "franciole.admin@gmail.com", "85917512051",
				TipoCliente.PESSOAFISICA, pe.encode("123456"));
		cli2.addPerfil(Perfil.ADMIN);

		cli2.getTelefones().addAll(Arrays.asList("44443333", "912341234"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Florianao", "2106", null, "Centro", "28177012", cli2, c2);
